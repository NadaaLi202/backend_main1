export const templeteEmail=(email)=>{
	return `<!DOCTYPE html>
									...
									<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
										<tr>
											<td style="background:#4e8991;text-align:center">
												<a href="http://127.0.0.1:5500/home.html?token=${email}" style="border: 1px solid #4e8991; font-family: Verdana, Arial,sans-serif; font-size:14px; mso-line-height-rule: exactly;line-height: 14px; text-decoration: none; padding: 10px 31px; color: #ffffff; font-weight:bold;display: block;">
												<strong>Home page here</strong>
												</a>
												<br/>
												 <a href="http://localhost:5000/api/v1/users/verify/${email}" style="border: 1px solid #ffffff; font-family: Verdana, Arial,sans-serif; font-size:14px; mso-line-height-rule: exactly;line-height: 14px; text-decoration: none; padding: 10px 31px; color:  #ffffff; font-weight:bold;display: block;"">
						...
						<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width:100%">
							<tr>
								<td class="tr_align" style="text-align:center;padding:10px">
									...
									<div class="tr_img_container" style="max-height:70px;">
